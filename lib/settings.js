...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, bittrex, bleutrade, crex, dex-trade, freiexchange/freixlite, nonkyc, poloniex, southxchange, tradeogre, unnamed, xeggex, yobit
  "exchanges": {
    ...
    // tradeogre: a collection of settings that pertain to the tradeogre exchange
    //        NOTE: tradeogre does not display a 24-hour chart due to a lack of OHLCV api data
    "tradeogre": {
      // enabled: Enable/disable the tradeogre exchange (true/false)
      //          If set to false, the tradeogre page will be completely inaccessible and no market data will be downloaded for this exchange
      "enabled": false,
      // trading_pairs: An array of market trading pair symbols
      //                You can add as many trading pairs as necessary
      //                All entries must specify your coins symbol as it is displayed on the exchange, followed by a slash (/) and ending with the symbol of the market or asset that is being traded against
