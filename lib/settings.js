...
exports.address_page = {
  ...
  // use_stealth_wording: Determine whether to use "Stealth" in place of "Unknown"
  "use_stealth_wording": false,
...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, bittrex, bleutrade, crex, dex-trade, freiexchange/freixlite, poloniex, southxchange, stex, yobit
  "exchanges": {
...
exports.blockchain_specific = {
  ...
  "heavycoin": {
    ...
    "api_cmds": {
      ...
      "getsupply": "getsupply",
      // getmaxsupply: Returns the max money supply. This should be a positive whole or decimal number
    ...
    "public_apis": {
      ...
      "getmaxsupply": {
        // enabled: Enable/disable the /api/getmaxsupply api endpoint (true/false)
        //          If set to false, the /api/getmaxsupply api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly)
        "enabled": true
      },
